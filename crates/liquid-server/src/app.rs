...
use super::research::{multi_research_file, topic_research_file};
use super::scraping::scrap_url;
use super::tasks::{delete_task, list_tasks, retry_task, stream_tasks};
use super::translate::translate_file;
use axum::{
    http::{
...
pub fn build_router(state: Arc<ServerContext>) -> Router {
    Router::new()
        ...
        .fallback_service(ServeDir::new(state.static_assets.root_dir.clone()))
