...
pub async fn build_research_source_pack_report(
    user_prompt: &str,
...
pub async fn collect_transient_repair_search_hints(
    subject: &str,
    queries: &[String],
...
pub fn build_local_pi_source_pack_provenance_source_cards(
