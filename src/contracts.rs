...
pub use liquid_protocol::{
    ...
    ResearchDebtItem, ResearchIterationState, ResearchQualityGateArtifact, ResearchReplayCaseInput,
    ResearchRunBudget, ResearchRunTerminalStatus, ResearchScrapeDiagnosticsSummary,
    ResearchSourceCandidateReport, ResearchSourceCard, ResearchSourceCoverageMiss,
    ResearchSourceDiagnosticsEnvelope, ResearchSourceDiagnosticsSummary, ResearchSourcePackReport,
    ResearchSourceQueryReport, ResearchWorkCheckpoint, ResearchWorkItem, ResearchWorkItemKind,
    ResearchWorkItemStatus, ScrapeDiagnostics, ScrapeRawCaptureDiagnostics,
};
#[allow(unused_imports)]
...
mod tests {
    ...
    fn artifact_schema_docs_list_current_contract_keys() {
        ...
        for required in [
            ...
            "`research_iteration_state` deserialize as `None`",
