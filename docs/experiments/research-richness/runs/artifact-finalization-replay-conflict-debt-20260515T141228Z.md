# Research Richness Run: artifact-finalization-replay-conflict-debt-20260515T141228Z

- Timestamp: 2026-05-15T14:12:30.493902+00:00
...
- JSON aggregate: artifact-finalization-replay-conflict-debt-20260515T141228Z.json
- CSV rows: artifact-finalization-replay-conflict-debt-20260515T141228Z.csv
- NDJSON rows: artifact-finalization-replay-conflict-debt-20260515T141228Z.ndjson
...
- Replay before: status=completed quality=untrusted critical_flags=0 last_failure=Research artifact gate failed: conflict map contains 1 unresolved conflict(s) not promoted to debt
...
- Final output: docs/experiments/research-richness/runs/artifact-finalization-replay-conflict-debt-20260515T141228Z/1-02-current-policy-regulatory-final-output.md
...
### Rubric Dimensions
- User intent fit: 5/5 [machine_readable_benchmark_artifacts; prompt term hits 31/63 for case 02-current-policy-regulatory with quality status passed]
- Direct answer usefulness: 5/5 [machine_readable_benchmark_artifacts; final output chars=20547 visible final answer=true task status=completed]
- Evidence/claim traceability: 5/5 [machine_readable_benchmark_artifacts; supported claims=15 total claims=15 unsupported_claim_count=0]
- Source quality and diversity: 5/5 [machine_readable_benchmark_artifacts; source_cards=18 distinct_hosts=5 official_sources=18 adopted_sources=8]
- Official/rumor/opinion separation: 5/5 [machine_readable_benchmark_artifacts; official_sources=18 rumor_or_opinion_sources=0 unsupported_claim_count=0]
- Handling of uncertainty and conflicts: 5/5 [machine_readable_benchmark_artifacts; conflicts=4 resolved=3 promoted_to_debt=1 open_debt=6 next_actions=11]
- Information resolution compared with available sources: 5/5 [machine_readable_benchmark_artifacts; adopted_sources=8 source_cards=18 claims=15 context_included_sources=8]
- Practical next steps or decision support: 5/5 [machine_readable_benchmark_artifacts; decision_terms=true open_debt=6 next_actions=11 prompt_hits=31/63]
...
- Treats rumor/opinion as official fact: clear (rumor/opinion sources=0 official sources=18 quality_status=passed)
- Ignores a major constraint from the prompt: clear (prompt term hits=31 threshold=2 for case 02-current-policy-regulatory)
- Produces final answer without meaningful evidence or uncertainty handling: clear (visible_final_answer=true source_cards=18 supported_claims=15 claim_log_visible=true)
...
The runtime pre-collected these web search results for the exact research subject: Compare Apple MacBook Pro and Framework Laptop options for a local Rust and AI workflow, using current official technica
...
1. Title: Framework | Refurbished Framework Laptop DIY Edition (13th Gen Intel®
   URL: https://frame.work/products/refurbished-laptop-diy-13-gen-intel?v=FRANDECP04R
   Source quality: high
   Snippet: Select Configuration ; US English (1st Gen) Intel® Core™ i5-1340P · Out of stock · $779.00 ; US English (1st Gen) Intel® Core™ i7-1360P · Out of stock · $989.00 ; US English (1st Gen) Intel® Core™ i7-1370P · Out of stock · $1,229.00

2. Title: Framework laptop
   URL: https://frame.work/de/en
   Source quality: high
- Task status: completed
- Quality status: passed
- Quality last failure: none
- Replay before: status=completed quality=passed critical_flags=0 last_failure=none
- Structured overall score: 5.00/5.00
- Critical failure flags: 0
- Structured visibility: task=completed, quality=passed, source_pack=success
- Measurement kind: artifact_backed_replay_validation
- Measurement caveat: Deterministic replay from frozen live bundles; validates rendering and strict gates without fresh model or network calls.
- Structured summary JSON: not included in sanitized snapshot
- Final output: docs/experiments/research-richness/runs/artifact-finalization-replay-conflict-debt-20260515T141228Z/2-03-comparative-product-technical-decision-final-output.md
- Source diagnostics JSON: not included in sanitized snapshot
- Controller artifacts JSON: not included in sanitized snapshot
- Resolved system prompt: not included in sanitized snapshot
- Resolved user prompt: not included in sanitized snapshot
...
### Rubric Dimensions
- User intent fit: 5/5 [machine_readable_benchmark_artifacts; prompt term hits 54/132 for case 03-comparative-product-technical-decision with quality status passed]
- Direct answer usefulness: 5/5 [machine_readable_benchmark_artifacts; final output chars=15625 visible final answer=true task status=completed]
- Evidence/claim traceability: 5/5 [machine_readable_benchmark_artifacts; supported claims=12 total claims=12 unsupported_claim_count=0]
- Source quality and diversity: 5/5 [machine_readable_benchmark_artifacts; source_cards=12 distinct_hosts=9 official_sources=10 adopted_sources=8]
- Official/rumor/opinion separation: 5/5 [machine_readable_benchmark_artifacts; official_sources=10 rumor_or_opinion_sources=0 unsupported_claim_count=0]
- Handling of uncertainty and conflicts: 5/5 [machine_readable_benchmark_artifacts; conflicts=3 resolved=3 promoted_to_debt=0 open_debt=3 next_actions=6]
- Information resolution compared with available sources: 5/5 [machine_readable_benchmark_artifacts; adopted_sources=8 source_cards=12 claims=12 context_included_sources=0]
- Practical next steps or decision support: 5/5 [machine_readable_benchmark_artifacts; decision_terms=true open_debt=3 next_actions=6 prompt_hits=54/132]
- Structure and readability: 5/5 [machine_readable_benchmark_artifacts; sections present: final_answer=true source_audit=true claim_log=true quality_gate=true appendix=true]
...
- Fabricated source, URL, date, price, or named entity: clear (invalid source card URL count=0)
- Fails to answer the user's actual question: clear (visible final answer section present=true)
- Treats rumor/opinion as official fact: clear (rumor/opinion sources=0 official sources=10 quality_status=passed)
- Ignores a major constraint from the prompt: clear (prompt term hits=54 threshold=2 for case 03-comparative-product-technical-decision)
- Produces final answer without meaningful evidence or uncertainty handling: clear (visible_final_answer=true source_cards=12 supported_claims=12 claim_log_visible=true)
